...
static const NMMetaPropertyInfo *const property_infos_IP4_CONFIG[] = {
	...
	PROPERTY_INFO (NM_SETTING_IP_CONFIG_DHCP_FQDN_FLAGS, DESCRIBE_DOC_NM_SETTING_IP4_CONFIG_DHCP_FQDN_FLAGS,
		.property_type =                &_pt_gobject_enum,
		.property_typ_data = DEFINE_PROPERTY_TYP_DATA (
			PROPERTY_TYP_DATA_SUBTYPE (gobject_enum,
				.get_gtype =            nm_dhcp_fqdn_flags_get_type,
			),
		)
	),
...
static const NMMetaPropertyInfo *const property_infos_IP6_CONFIG[] = {
	...
	PROPERTY_INFO (NM_SETTING_IP_CONFIG_DHCP_FQDN_FLAGS, DESCRIBE_DOC_NM_SETTING_IP6_CONFIG_DHCP_FQDN_FLAGS,
		.property_type =                &_pt_gobject_enum,
		.property_typ_data = DEFINE_PROPERTY_TYP_DATA (
			PROPERTY_TYP_DATA_SUBTYPE (gobject_enum,
				.get_gtype =            nm_dhcp_fqdn_flags_get_type,
